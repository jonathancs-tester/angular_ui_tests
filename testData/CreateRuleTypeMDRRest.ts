...
export class CreateRuleTypeMDRRest {
  async performPost(
    projectId: string,
    ruleId: string,
    user: string,
    ...
    try {
      ...
      let response = await axios({
        ...
        data: {
          ...
          ruleSpaceSpec: {
            id: 'cwt_orderItemActionRuleSpace',
            href: '/ecm/ecm/CatalogManagement/v2/ruleSpaceSpecification/cwt_orderItemActionRuleSpace'
        },
        },
      });
    } catch (error) {
